			...
			'POPUP_MENU_ITEMS' =>
				...
				|| (
                    ...
                    /*array(
							...
							array(
								'tabId' => 'popupMenuOptions',
								'text' => 'По имени (По возрастанию)',
								'className' => ($arResult['NEW_TASKS_ORDER'] == 'TITLE:ASC') ? 'menu-popup-item-accept' : 'menu-popup-item-none',
								'onclick' => 'BX.delegate(BX.Tasks.KanbanComponent.ClickSort)',
								'params' => '{order: "TITLE:ASC"}'
							),
                            array(
								'tabId' => 'popupMenuOptions',
								'text' => 'По имени (По убыванию)',
								'className' => ($arResult['NEW_TASKS_ORDER'] == 'TITLE:DESC') ? 'menu-popup-item-accept' : 'menu-popup-item-none',
								'onclick' => 'BX.delegate(BX.Tasks.KanbanComponent.ClickSort)',
                            ...
                            array(
								'tabId' => 'popupMenuOptions',
								'text' => 'По ID',
								'className' => ($arResult['NEW_TASKS_ORDER'] == 'ID') ? 'menu-popup-item-accept' : 'menu-popup-item-none',
								'onclick' => 'BX.delegate(BX.Tasks.KanbanComponent.ClickSort)',
								'params' => '{order: "ID"}'
							),
							array(
